...
func main() {
	...
	db := pg.Connect(&pg.Options{
		Addr:     postgresHost + ":" + postgresPort, // TODO gemacht
		User:     postgresUsername,
		Password: postgresPassword,
		Database: postgresDB, // TODO gemacht
	})
	defer db.Close()
	...
	// MinIO Object store
	minioEndpoint := os.Getenv("MINIO_ENDPOINT")                       // TODO gemacht
	if minioEndpoint == "" {
    minioEndpoint = "localhost:9000"
	}

	minioAccessKeyID := os.Getenv("MINIO_ACCESS_KEY")                  // TODO gemacht
	minioSecretAccessKey := os.Getenv("MINIO_SECRET_KEY") 			   // TODO gemacht
	minioUseSSL := false

	// MinIO Make a new bucket called "images".
	bucketName := os.Getenv("BUCKET_NAME") // TODO gemacht
	if bucketName == "" {
    bucketName = "infiles"
	}
	...
	conn, err := amqp.Dial(rabbitURL) // TODO gemacht
